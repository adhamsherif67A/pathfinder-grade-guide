            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-semibold">{stats.mechatronicsProgress.earned} / {stats.mechatronicsProgress.total} Cr. Hr.</span>
                </div>
              ...
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-semibold">{stats.uclanProgress.earned} / {stats.uclanProgress.total} Cr. Hr.</span>
                </div>
                <div className="h-3 w-full bg-white/5 rounded-full overflow-hidden">
                  <div 
              ...
              <div className="grid sm:grid-cols-3 gap-4 pt-2">
                <div className="glass rounded-xl p-3 text-center">
                  ...
                  <div className="text-[10px] text-muted-foreground">{stats.gradeBreakdown.topGradeCount} times</div>
                </div>
                <div className="glass rounded-xl p-3 text-center">
                  <div className="text-[10px] uppercase text-muted-foreground">Fails</div>
                  <div className="text-xl font-bold text-destructive">{stats.gradeBreakdown.failCount}</div>
                ...
                <div className="glass rounded-xl p-3 text-center">
                  ...
                  <div className="text-[10px] text-muted-foreground">GPA {stats.bestSemester?.gpa.toFixed(2) || "0.00"}</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="glass-strong rounded-2xl p-6 flex flex-col">
            ...
            <div className="mt-auto">
              <div className="glass rounded-xl p-3 text-center mb-2">
                ...
                <div className="text-xl font-bold">{rec.latestSemesterGpa !== undefined ? rec.latestSemesterGpa.toFixed(2) : "—"}</div>
              </div>
  ...
  return (
    <div className="glass-strong rounded-2xl p-5 flex items-center gap-4">
      ...
      <div className={muted ? "animate-pulse" : undefined}>
        ...
        <div className={`text-xl font-bold truncate max-w-[120px] sm:max-w-none ${className}`}>{value}</div>
      </div>
    </div>
  );
}
